...
export const topics = {
  ...
  overview: {
    ...
    examples: ["codexteer supervise <THREAD> --agent claude", "codexteer threads list --desktop-only --json", "codexteer read <THREAD> --json", "codexteer help send"],
    use_cases: [
    ...
    notes: ["THREADにはUUIDまたはcodex://threads/...を指定します。", "監督役の対話起動: codexteer supervise <THREAD> --agent claude [-- <AGENT-ARGS...>]。superviseの標準入出力と終了コードはClaudeのものです。", "コマンド別のhelpには、使い所・出力・例・制約を載せています。help自体も --json に対応します。"],
  },
  read: {
